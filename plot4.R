...
## This function creates a png file of a plot4
createPlot4 = function() {
        ...
        plot(proj1Data$dateTime, proj1Data$Voltage, type="l",
        ...
        plot(proj1Data$dateTime, proj1Data$Global_reactive_power, type="l",
